            ...
            <div class="col-md-12">
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">
                        <form role="form" action="{{ route('tipo-documentos.store') }}" method="POST" class="form-validate">
                            @csrf
                            <div class="form-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label" for="nombre_tipoDocumento">Nombre De Tipo Documentos</label>
                                                <input type="text" class="form-control inputLetras" id="nombre_tipoDocumento" name="nombre_tipoDocumento" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                                        </div>
                                    </div>
