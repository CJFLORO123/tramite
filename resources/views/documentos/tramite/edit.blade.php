...
@section('titlePage', 'Editar - Trámite | AFOSECAT San Martín')
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        ...
                        <i class="icon-folder-alt"></i>
                            <span class="caption-subject bold uppercase font-blue-madison"> EDITAR DOCUMENTOS RECIBIDOS </span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        <form role="form" action="{{ route('documentos.update', $documentos->id) }}" method="POST" class="form-validate" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            <div class="form-body">
                            <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-center"  id="micampo" autocomplete="off" readonly value="{{ $documentos->num_recepcion }} - {{ $documentos->periodo->anio }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="fecha_recepcion" class="control-label">Fecha Registro</label>
                                            <input type="text" id="fecha_recepcion" name="fecha_recepcion" class="form-control text-center date-picker data-required" autocomplete="off" value="{{ $documentos->get_fecha }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="hora_recepcion" class="control-label">Hora Registro</label>
                                            <input type="text"  name="hora_recepcion" id="hora_recepcion" class="form-control timepicker timepicker-24 text-center" autocomplete="off" value="{{ $documentos->hora_recepcion }}">
                                        </div>
                                    </div>
                                </div>
                            <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="tipo_tramite" id="tipo_tramite" class="form-control"  autocomplete="off" readonly value="{{ $documentos->tipo_tramite }}">
                                        </div>
                                    </div>
                                         ...
                                         <div id="recibidos">
                                             <div class="col-md-10">
                                                 <div class="form-group">
                                                      ...
                                                      <input type="text" id="solicitante" name="solicitante" class="form-control input-recibidos inputLetras" autocomplete="off" value="{{ $documentos->remitente->nom_solicitante }}" placeholder="Buscar Remitente" onkeyup="javascript:this.value=this.value.toUpperCase();">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                     ...
                                     @else
                                     <option value="{{ $tipoDocumento->id }}">{{ $documentos->nombre_tipoDocumento }}</option>
                                     @endif
                                     @endforeach
                                     </select>
                                </div>
                                ...
                                <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="num_documento" name="num_documento" class="form-control" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{ $documentos->num_documento }}">
                                        </div>
                                    </div>
                                 ...
                                 <div class="col-md-12">
                                      <div class="form-group">
                                            ...
                                            <input type="text" id="asunto" name="asunto" class="form-control" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{ $documentos->asunto }}">
                                        </div>
                                    </div> 
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="detalle" class="control-label">Detalle</label>
                                            <textarea id="detalle" name="detalle" class="form-control" rows="5" onkeyup="javascript:this.value=this.value.toUpperCase();">{{ $documentos->detalle }}</textarea>
                                        </div>
                                    </div>  
                          </div>
                          <div class="row">
