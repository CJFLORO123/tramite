...
@section('titlePage', 'Reporte Tipo Trámite | AFOSECAT San Martín')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">Reporte Tipo Trámite</a>
                </li>
            </ul>
        </div>
        
        <h1 class="page-title"> Reporte Tipo Trámite </h1>
                    ...
                    <div class="portlet-body form">
                        ...
                        <form role="form">
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn btn-danger" id="exportar_tipo"><i class="fa fa-file-excel-o"></i> Exportar PDF</button>
                            </div>
                        </form>
                    </div>
                </div>
